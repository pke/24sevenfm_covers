...
function makeRatingSlot(slot) {
    ...
    function reveal(front, certification) {
        ...
        if (fx === "fliph" || fx === "flipv") {
            ...
            // Keeping an SVG in two permanent 180ø GPU layers makes it look rasterized.
...
function showCover(url) {
    ...
    preloadImage(url, function () {
        ...
        if (coverBox.dataset.fx !== fx) {
            ...
            // ANIMATING toward its 90ø park when the front flip retargets it to 0ø -
            // a 0ø0ø no-op, and the new cover just pops in statically. One
